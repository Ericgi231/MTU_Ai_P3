...
def rule_caterpillar():
    ...
    "*** YOUR CODE HERE ***"
    #Bill ate the salt or Caterpillar is a liar
    return [[-1, 5]]

def rule_bill():
    "Return the CNF form of BILL THE LIZARD's statement"
    "*** YOUR CODE HERE ***"
    #Caterpillar told the truth or bill is a liar 
    return [[5, -2]]

def rule_cheshire():
    "Return the CNF form of CHESHIRE CAT's statement"
    "*** YOUR CODE HERE ***"
    #Chesire did not eat the salt or Chesire is a liar
    return [[-6, -3]]
...
def rule_salt():
    ...
    "*** YOUR CODE HERE ***"
    return [[4,5,6],[4,-5],[4,-6],[5,-4],[5,-6],[6,-4],[6,-5]]
